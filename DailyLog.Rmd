...
wordcloud2(summary, shape='circle', color = "lightgreen", backgroundColor = "black", size=.5)
wordcloud2(summary, size = 1, color="lightgreen", backgroundColor="black",figPath = "testpic2.png")
```

No such luck with the custom images above, so it's time to try a new method: the `ggwordcloud` package.

```{r}
library(ggwordcloud)
ggplot(summary, aes(label = artistName, size = freq)) +
  geom_text_wordcloud_area(
    mask = png::readPNG(system.file("testpic2.png",
