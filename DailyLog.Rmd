...
filepath <- "~/R/Spotify/testpic2.png"
wordcloud2(summary[1:50,], size =.25, color="lightgreen", figPath = filepath)
```
...
library(ggwordcloud)
ggplot(summary[1:50,], aes(label = artistName, size = freq)) +
  geom_text_wordcloud_area(
    mask = png::readPNG(system.file("~/R/Spotify/testpic2.png",
